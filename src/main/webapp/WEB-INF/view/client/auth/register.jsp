                                        ...
                                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            ...
                                            <div class="card-body">
                                                <form:form action="/register" method="post" modelAttribute="regUser">
                                                    <c:set var="existedEmail">
                                                        <form:errors path="email" cssClass="invalid-feedback" />
                                                    </c:set>
                                                    <c:set var="errorCfPassword">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        <form:input
                                                            class="form-control ${not empty existedEmail ? 'is-invalid' : ''}"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                                <form:input
                                                                    class="form-control ${not empty errorCfPassword ? 'is-invalid' : ''}"
                                                                    id="inputPasswordConfirm" type="password"
                                                                    placeholder="Confirm password"
                                                                    path="confirmPassword" />${errorCfPassword}
                                                    ...
                                                    <div class="mt-4 mb-0">
                                                        <div class="d-grid">
                                                            <form:button type="submit"
                                                                class="d-grid btn btn-primary btn-block">Create account
                                                            </form:button>
                                                        </div>
                                                    </div>
                                                </form:form>
